...
var index = (() => {
    var _ref = _asyncToGenerator(function* (endpoint, countryCode, docNumber, timeout, callback) {
        ...
        const parsedUrl = yield url.parse(config.serviceUrl);
        ...
        const req = yield requester.request(options, function (res) {
